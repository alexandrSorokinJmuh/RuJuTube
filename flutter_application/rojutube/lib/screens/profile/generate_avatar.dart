...
import 'package:RoJuTube/screens/profile/generate_avatar_state.dart';
...
class GenerateAvatarPage extends StatelessWidget {
  GenerateAvatarPage({super.key});

  final GenerateAvatarState _state = GenerateAvatarState();
        ...
        return Stepper(
          ...
          steps: [
            ...
            Step(
              ...
              state: _state.currentStep == 2
                  ? StepState.editing
                  : _state.currentStep > 2
                      ? StepState.complete
                      : StepState.indexed,
              isActive: _state.currentStep == 2,
            )
          ],
